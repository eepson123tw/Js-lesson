...
if (!trafficLightStatus) {
    console.log(`現在是紅燈,馬路上有${people}個人,天上有${sun}個,${cloud}朵雲!`)
};

//第五題 看圖宣告變數

let point = 50;
const title = "【最終試煉】 使用jQuery 打造互動性網頁動畫效果";
let passPeopleNum = 62;
let passCurrentDay = 16;
let passCurrentTime = 9;
const cardImg = "./img/*.png";

console.log(point, title, passPeopleNum, passCurrentDay, passCurrentTime, cardImg);
...
let b = 0; //宣告 b 變數 賦值0
a = 3; //a 變數賦值 3 
a = b + 2; // a變數 賦值 0 + 2 目前 a為 2 
a - b; // 2 - 0 
b += 1; // b賦值 為 1  b= 0+1; 目前 b為 1
console.log(a, b);
