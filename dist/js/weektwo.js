...
(function() {
  ...
  const robootUseArea = document.querySelector('.robot__use');
  const userUseArea = document.querySelector(".user__use");
  ...
  btn.forEach((item) => {
    ...
    item.addEventListener('click', function(e) {
      ...
      robootUseArea.innerText = `${playerA[pcUse]}`;
      userUseArea.innerText = `${playerB[userUse]}`;

      if (playerA[pcUse] == playerB[userUse]) {
        alert('平手');
      }
      if (playerA[pcUse] == '剪刀' && playerB[userUse] == '石頭') {
        alert(`你贏了`);
      }
      if (playerA[pcUse] == '石頭' && playerB[userUse] == '剪刀') {
        alert(`電腦贏了`);
      }
      if (playerA[pcUse] == '布' && playerB[userUse] == '剪刀') {
        alert(`你贏了`);
      }
      if (playerA[pcUse] == '剪刀' && playerB[userUse] == '布') {
        alert(`電腦贏了`);
      }
      if (playerA[pcUse] == '石頭' && playerB[userUse] == '布') {
        alert(`你贏了`);
      }
      if (playerA[pcUse] == '布' && playerB[userUse] == '石頭') {
        alert(`電腦贏了`);
      }
